...
set_property webtalk.parent_dir D:/GitCode/ImageProcessingofSketch/ImageProcessing.cache/wt [current_project]
set_property parent.project_path D:/GitCode/ImageProcessingofSketch/ImageProcessing.xpr [current_project]
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/GitCode/ImageProcessingofSketch/ImageProcessing.runs/outputBuffer_synth_1 -new_name outputBuffer -ip [get_ips outputBuffer]]
